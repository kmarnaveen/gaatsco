...
const stats = [
  ...
  { value: "24hr", label: "Response time", sub: "We reply fast" },
]
...
export function TrustBar() {
  return (
    <section className="border-b bg-card py-8 shadow-sm">
      <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
        ...
        <div className="mt-8 grid grid-cols-1 gap-3 border-t pt-8 text-xs text-muted-foreground sm:grid-cols-3 sm:gap-6">
